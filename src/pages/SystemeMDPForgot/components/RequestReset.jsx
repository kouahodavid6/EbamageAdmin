...
const RequestReset = () => {
    ...
    const { requestResetCode, loading, error, setEmail: setStoreEmail } = useResetPasswordStore();
        ...
        <div className="w-full max-w-md mx-auto">
            ...
            >
                <p className="text-center text-sm text-emerald-700">
                    Le code sera envoyé à l'adresse email associée à votre compte administrateur.
                </p>
            </motion.div>
        </div>
    );
