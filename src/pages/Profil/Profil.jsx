...
const Profil = () => {
    ...
    const { admin, fetchAdminInfo, loading } = useAdminInfoStore();
                                ...
                                <AnimatePresence mode="wait">
                                    {activeTab === "infos" && (
                                        <motion.div
                                            ...
                                            exit="exit"
                                        >
                                            <InfoForm admin={admin} loading={loading} />
                                        </motion.div>
                                    )}
                                    {activeTab === "password" && (
                                        <motion.div
                            ...
                            {!loading && admin && (
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                        ...
                                        >
                                            <Calendar className="w-4 h-4 text-green-500" />
                                            <span>Dernière modification: {new Date(admin?.updated_at).toLocaleDateString('fr-FR')}</span>
                                        </motion.div>
                                        <motion.div 
                                            className="flex items-center space-x-3 text-green-700"
                                            whileHover={{ x: 5 }}
