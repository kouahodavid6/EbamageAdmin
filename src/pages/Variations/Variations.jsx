...
const Variations = () => {
    ...
    const { variations, fetchVariations } = useVariationStore();
            ...
            <div className="flex-1 min-w-0 flex flex-col">
                ...
                <main className="flex-1 p-4 sm:p-6 overflow-auto bg-gray-50">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                        <div>
                            <h1 className="text-xl xs:text-2xl sm:text-3xl font-bold text-green-900">Gestion des variations</h1>
                    ...
                    <div className="space-y-4">
                            ...
                            >
                                <div className="flex items-start justify-between mb-4">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <h3 className="text-lg font-semibold text-green-900">{variation.nom_variation}</h3>
                                    </div>
                                </div>
                                ...
                                {variation.valeurs?.length > 0 && (
                                    <div>
                                        <p className="text-sm font-medium text-green-700 mb-2">Valeurs disponibles :</p>
                        ...
                        {variations.length === 0 && (
                            <div className="text-center py-12">
                                ...
                                <h3 className="text-lg font-medium text-green-900 mb-2">Aucune variation créée</h3>
                                <p className="text-green-600 mb-6">Commencez par créer votre première variation</p>
                                <button
                                    onClick={() => setModalOpen(true)}
